...
exports.possiblyActivate = possiblyActivate;
exports.activate = activate;
exports.genCoords = genCoords;
exports.calcSlope = calcSlope;
exports.dismissTimeout = dismissTimeout;
exports.getActivationDelay = getActivationDelay;
var DELAY = 150;

function possiblyActivate(row, setTimeoutID, setLastDelayLoc, setActiveRow, activeRow, tolerance, instance, lastDelayLoc, mouseLocs, direction) {
...
function activate(row, setActiveRow, activeRow) {
    if (row === activeRow) {
        return;
    }
    setActiveRow(row);
...
function dismissTimeout(timeoutID) {
    if (timeoutID) {
...
function getActivationDelay(activeRow, tolerance, instance, lastDelayLoc, mouseLocs, direction, setTimeoutID, setLastDelayLoc) {
    if (activeRow < 0) {
        return 0;
    }
