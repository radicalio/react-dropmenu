...
export function possiblyActivate(row, setTimeoutID, setLastDelayLoc, setActiveRow, activeRow, tolerance, instance, lastDelayLoc, mouseLocs, direction) {
    ...
    const delay = getActivationDelay(activeRow, tolerance, instance, lastDelayLoc, mouseLocs, direction, setTimeoutID, setLastDelayLoc);
    if (delay) {
...
export function getActivationDelay( activeRow, tolerance, instance, lastDelayLoc, mouseLocs, direction, setTimeoutID, setLastDelayLoc ) {
    ...
    const bounds = instance.current.getBoundingClientRect();
    const upperLeft = genCoords(
        bounds.left,
    ...
    const decreasingSlope = calcSlope(loc, decreasingCorner),
